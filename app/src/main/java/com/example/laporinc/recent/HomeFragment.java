                        ...
                        public void onDataChange(final DataSnapshot dataSnapshot) {
                            ...
                            new Thread( new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Post recentCardViewModel;

                                    Log.i( "loading", "next trip" );

                                    if (dataSnapshot.getChildrenCount() == 0) {
                                        Log.i( "datasnapshot", "nool" );
                                    }
                                    ...
                                    for (DataSnapshot child : dataSnapshot.getChildren()) {
                                        ...
                                        recentCardViewModel = new Post( lokasi, deskripsi, date, idPelapor, jenisPelanggaran, status, imageKey, order );
                                        posts.add( recentCardViewModel );
                                        keys.add( key );
                ...
                new Thread( new Runnable() {
                    ...
                    public void run() {
                        ...
                        for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                            ...
                            oldestPost = post.getOrder();
                            //Log.i( "OldestPostId refresh", listener.oldestPostId );
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                new Thread( new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.i( "kegiatan", "mengambil nama untuk diletak di Action Bar" );
                        User user = dataSnapshot.getValue( User.class );
                        //homeFragment.setNamaUser( user.getNama() );
                        namaUser = user.getNama();
                        poin = user.getPoin();

                        Log.i( "nama di action bar", namaUser );
